...
# Base: iraf-community/unix/hlib/login.cl — patch LIneA: uparm -> $HOME/iraf/uparm/
# (before-notebook.d cria esse diretório; ~/.iraf/uparm em alguns PVCs falha em uparm$pipe).
...
set uparm = (envget("HOME") // "/iraf/uparm/")
...
# paths and load personalized packages from your loginuser.cl.
clpackage
